...
CREATE TABLE amazon_sales_data.staged_cleaned_data
...
FROM amazon_sales_data.staged_cleaned_data
GROUP BY `Order Date`, `Purchase Address`;

-- Create a new column to store the city data
